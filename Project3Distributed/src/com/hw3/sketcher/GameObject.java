...
public abstract class GameObject implements Serializable {
	...
	public static GameObject parseGameString(String[] vals) {
		...
		if (vals[0].equals("PLAYER")) {
			...
			Player p = new Player(null, x_pos, y_pos, diameter, new Color(r, g, b));
			p.GAME_OBJECT_ID = vals[1];
			return p;
			...
			Platform p =  new Platform(null, x_pos, y_pos, length, breadth, new Color(r, g, b));
			p.GAME_OBJECT_ID = vals[1];
			return p;
			...
			Floor f =  new Floor(null, height, width);
			f.GAME_OBJECT_ID = vals[1];
			return f;
		}
